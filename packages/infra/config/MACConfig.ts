...
export const MACDescription = {
    'InvoiceAssistant': "Main coordinator for invoice processing workflows, handling document review, field extraction, vendor identification, and SAP data input form generation.",
    'InvoiceAppAssistant': "Invoice Processing Assistant for document processing, field extraction, and verification. Guides users through invoice workflows.",
    'VendorIdentificationAgent': "Identifies vendors from invoice data, consolidates information into CSV format, and generates SAP data input forms."
}
